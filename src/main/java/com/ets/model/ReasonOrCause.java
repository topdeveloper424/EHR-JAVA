 ...
 *Module Name:
 *Parameter Definition: Type object of ReasonOrCause Class
...
@Entity
@Table(name = "reason_or_cause")
public class ReasonOrCause {
	...
	private  StringProperty reasonCause = new SimpleStringProperty(this, "reasonCause");

	@Column(name = "reason_cause")
	public  String getReasonCause() {
		return reasonCause.get();
	}

	public  void setReasonCause(String reasonCause) {
		this.reasonCause.set(reasonCause);
	}

	public StringProperty reasonCauseProperty() {
		return reasonCause;
	}
