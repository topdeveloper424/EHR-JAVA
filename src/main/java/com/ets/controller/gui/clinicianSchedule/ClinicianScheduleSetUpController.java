...
import com.ets.controller.entity.clinicianBlockTime.ClinicianBlockTimeEntityController;
import com.ets.controller.entity.clinicianDaysBlockException.ClinicianBlockDaysExceptionEntityController;
...
public class ClinicianScheduleSetUpController implements Initializable{
	...
	List<ClinicianSchedule> clinicianSchedulesDateList = null;
	...
	private ClinicianScheduleViewController clinicianScheduleViewController=null;
    ...
    public void setClinicianScheduleViewController(ClinicianScheduleViewController clinicianScheduleViewController){
		...
		this.clinician = clinicianScheduleViewController.clinician;
	...
	public void viewClinicianSchDate(){
		...
		clinicianSchedulesDateList = new ClinicianScheduleEntityController().viewClinicianScheduleById(ClinicianSelectController.clinician.getId());
...
public void componentGenerator(int lengthToGen){
	...
	Label[] timeSlotlb = new Label[lengthToGen];
		...
		sundayText[i].setOnMouseClicked(new EventHandler<MouseEvent>() {
		    public void handle(MouseEvent me) {
		    	if (me.getClickCount() == 2) {
		    		blockClinicianSchedule(sundayText[m],timeSlotString[m]);
		    		
		    	}
		    	if (me.getClickCount() == 1) {
		    		showTimeLabel.setText(timeSlotString[m]);
		    		startTimetext.setText(clinicianSchedulesDateList.get(0).getOpenTime());
		    		endTime.setText(clinicianSchedulesDateList.get(0).getCloseTime());
		...
		monText[i].setOnMouseClicked(new EventHandler<MouseEvent>() {
		    public void handle(MouseEvent me) {
		    	if (me.getClickCount() == 2) {
		    		blockClinicianSchedule(monText[m],timeSlotString[m]);
		    		
		    	}
		    	if (me.getClickCount() == 1) {
		    		showTimeLabel.setText(timeSlotString[m]);
		    		startTimetext.setText(clinicianSchedulesDateList.get(1).getOpenTime());
		    		endTime.setText(clinicianSchedulesDateList.get(1).getCloseTime());
		...
		tuesText[i].setOnMouseClicked(new EventHandler<MouseEvent>() {
		    public void handle(MouseEvent me) {
		    	if (me.getClickCount() == 2) {
		    		blockClinicianSchedule(tuesText[m],timeSlotString[m]);
		    		
		    	}
		    	if (me.getClickCount() == 1) {
		    		showTimeLabel.setText(timeSlotString[m]);
		    		startTimetext.setText(clinicianSchedulesDateList.get(2).getOpenTime());
		    		endTime.setText(clinicianSchedulesDateList.get(2).getCloseTime());
		...
		wedText[i].setOnMouseClicked(new EventHandler<MouseEvent>() {
		    public void handle(MouseEvent me) {
		    	if (me.getClickCount() == 2) {
		    		blockClinicianSchedule(wedText[m],timeSlotString[m]);
		    		
		    	}
		    	if (me.getClickCount() == 1) {
		    		showTimeLabel.setText(timeSlotString[m]);
		    		startTimetext.setText(clinicianSchedulesDateList.get(3).getOpenTime());
		    		endTime.setText(clinicianSchedulesDateList.get(3).getCloseTime());
		...
		thursText[i].setOnMouseClicked(new EventHandler<MouseEvent>() {
		    public void handle(MouseEvent me) {
		    	if (me.getClickCount() == 2) {
		    		blockClinicianSchedule(thursText[m],timeSlotString[m]);
		    		
		    	}
		    	if (me.getClickCount() == 1) {
		    		showTimeLabel.setText(timeSlotString[m]);
		    		startTimetext.setText(clinicianSchedulesDateList.get(4).getOpenTime());
		    		endTime.setText(clinicianSchedulesDateList.get(4).getCloseTime());
		...
		friText[i].setOnMouseClicked(new EventHandler<MouseEvent>() {
		    public void handle(MouseEvent me) {
		    	if (me.getClickCount() == 2) {
		    		blockClinicianSchedule(friText[m],timeSlotString[m]);
		    		
		    	}
		    	if (me.getClickCount() == 1) {
		    		showTimeLabel.setText(timeSlotString[m]);
		    		startTimetext.setText(clinicianSchedulesDateList.get(5).getOpenTime());
		    		endTime.setText(clinicianSchedulesDateList.get(5).getCloseTime());
		...
		satText[i].setOnMouseClicked(new EventHandler<MouseEvent>() {
		    public void handle(MouseEvent me) {
		    	if (me.getClickCount() == 2) {
		    		blockClinicianSchedule(satText[m],timeSlotString[m]);
		    		
		    	}
		    	if (me.getClickCount() == 1) {
		    		showTimeLabel.setText(timeSlotString[m]);
		    		startTimetext.setText(clinicianSchedulesDateList.get(6).getOpenTime());
		    		endTime.setText(clinicianSchedulesDateList.get(6).getCloseTime());
    		...
    		Arrays.fill(activeClinicTimeSat, true);
    		 ...
    		 viewClinicianSchDate();
    				...
    				for(int j=0;j<7;j++){
    					try{
    					   if(clinicScheduleTimeList.get(j).getOpenTime()!=null && clinicScheduleTimeList.get(j).getCloseTime()!=null){
    						 ...
    						 int clinicianOpenTimeInd = Arrays.asList(timeSlotString).indexOf(clinicianSchedulesDateList.get(j).getOpenTime());
    						 int clinicianCloseTimeInd = Arrays.asList(timeSlotString).indexOf(clinicianSchedulesDateList.get(j).getCloseTime());
    				...
    				if(j==0){
    			     ...
    			     if(clinicianOpenTimeInd>openIndex&&clinicianOpenTimeInd!=-1){
							int clinicianOpenIndex = (clinicianOpenTimeInd-openIndex);
							while(clinicianOpenTimeInd>=openIndex){
							    sundayText[clinicianOpenTimeInd].setStyle("-fx-background-color :#ABEBC6");
								sundayText[clinicianOpenTimeInd].setDisable(true);
								activeClinicTimeSun[clinicianOpenTimeInd]=true;
								--clinicianOpenTimeInd;
							}
							
							
					}else{
				      }
					if(clinicianCloseTimeInd<=endOfIndex&&clinicianCloseTimeInd!=-1){
						    while(clinicianCloseTimeInd<endOfIndex){
                               sundayText[clinicianCloseTimeInd].setStyle("-fx-background-color :#ABEBC6");
						       sundayText[clinicianCloseTimeInd].setDisable(true);
						   	activeClinicTimeSun[clinicianCloseTimeInd]=true;
							   ++clinicianCloseTimeInd;
							}
    			    ...
    			    if(j==1){
    				      ...
    				      if(clinicianOpenTimeInd>openIndex&&clinicianOpenTimeInd!=-1){
  							     while(clinicianOpenTimeInd>=openIndex){
  							        monText[clinicianOpenTimeInd].setStyle("-fx-background-color :#ABEBC6");
  								    monText[clinicianOpenTimeInd].setDisable(true);
  								  activeClinicTimeMon[clinicianOpenTimeInd]=true;
  								    --clinicianOpenTimeInd;
    				      ...
    				      if(clinicianCloseTimeInd<=endOfIndex&&clinicianCloseTimeInd!=-1){
                                 ...
                                 while(clinicianCloseTimeInd<endOfIndex){
  							          monText[clinicianCloseTimeInd].setStyle("-fx-background-color :#ABEBC6");
                                      monText[clinicianCloseTimeInd].setDisable(true);
                                      activeClinicTimeMon[clinicianCloseTimeInd]=true;
  								     ++clinicianCloseTimeInd;
  							     }
    			    ...
    			    if(j==2){
    				      ...
    				      if(clinicianOpenTimeInd>openIndex&&clinicianOpenTimeInd!=-1){
							     while(clinicianOpenTimeInd>=openIndex){
							        tuesText[clinicianOpenTimeInd].setStyle("-fx-background-color :#ABEBC6");
							        tuesText[clinicianOpenTimeInd].setDisable(true);
							        activeClinicTimeTues[clinicianOpenTimeInd]=true;
								    --clinicianOpenTimeInd;
 				      ...
 				      if(clinicianCloseTimeInd<=endOfIndex&&clinicianCloseTimeInd!=-1){
                              ...
                              while(clinicianCloseTimeInd<endOfIndex){
                            	  tuesText[clinicianCloseTimeInd].setStyle("-fx-background-color :#ABEBC6");
                            	  tuesText[clinicianCloseTimeInd].setDisable(true);
                            	  activeClinicTimeTues[clinicianCloseTimeInd]=true;
								  ++clinicianCloseTimeInd;
							     }
    			    ...
    			    if(j==3){
    				      ...
    				      if(clinicianOpenTimeInd>openIndex&&clinicianOpenTimeInd!=-1){
							     while(clinicianOpenTimeInd>=openIndex){
							        wedText[clinicianOpenTimeInd].setStyle("-fx-background-color :#ABEBC6");
							        wedText[clinicianOpenTimeInd].setDisable(true);
							        activeClinicTimeWed[clinicianOpenTimeInd]=true;
								    --clinicianOpenTimeInd;
 				      ...
 				      if(clinicianCloseTimeInd<=endOfIndex&&clinicianCloseTimeInd!=-1){
                              ...
                              while(clinicianCloseTimeInd<endOfIndex){
                            	  wedText[clinicianCloseTimeInd].setStyle("-fx-background-color :#ABEBC6");
                            	  wedText[clinicianCloseTimeInd].setDisable(true);
                            	  activeClinicTimeWed[clinicianCloseTimeInd]=true;
								  ++clinicianCloseTimeInd;
							     }
    			    ...
    			    if(j==4){
     				      ...
     				      if(clinicianOpenTimeInd>openIndex&&clinicianOpenTimeInd!=-1){
 							     while(clinicianOpenTimeInd>=openIndex){
 							        thursText[clinicianOpenTimeInd].setStyle("-fx-background-color :#ABEBC6");
 							       thursText[clinicianOpenTimeInd].setDisable(true);
 							      activeClinicTimeThurs[clinicianOpenTimeInd]=true;
 							       --clinicianOpenTimeInd;
  				      ...
  				      if(clinicianCloseTimeInd<endOfIndex&&clinicianCloseTimeInd!=-1){
                               ...
                               while(clinicianCloseTimeInd<endOfIndex){
                            	   thursText[clinicianCloseTimeInd].setStyle("-fx-background-color :#ABEBC6");
                            	   thursText[clinicianCloseTimeInd].setDisable(true);
                            	   activeClinicTimeThurs[clinicianCloseTimeInd]=true;
 								  ++clinicianCloseTimeInd;
 							     }
    			    ...
    			    if(j==5){
    				        ...
    				        if(clinicianOpenTimeInd>openIndex&&clinicianOpenTimeInd!=-1){
							     while(clinicianOpenTimeInd>=openIndex){
							        friText[clinicianOpenTimeInd].setStyle("-fx-background-color :#ABEBC6");
							        friText[clinicianOpenTimeInd].setDisable(true);
							        activeClinicTimeFri[clinicianOpenTimeInd]=true;
								    --clinicianOpenTimeInd;
 				      ...
 				      if(clinicianCloseTimeInd<endOfIndex&&clinicianCloseTimeInd!=-1){
                              ...
                              while(clinicianCloseTimeInd<=endOfIndex){
                            	  friText[clinicianCloseTimeInd].setStyle("-fx-background-color :#ABEBC6");
                            	  friText[clinicianCloseTimeInd].setDisable(true);
                            	  activeClinicTimeFri[clinicianCloseTimeInd]=true;
								  ++clinicianCloseTimeInd;
							     }
    			    ...
    			    if(j==6){
    				      ...
    				      if(clinicianOpenTimeInd>openIndex&&clinicianOpenTimeInd!=-1){
							     while(clinicianOpenTimeInd>=openIndex){
							        satText[clinicianOpenTimeInd].setStyle("-fx-background-color :#ABEBC6");
							        satText[clinicianOpenTimeInd].setDisable(true);
							        activeClinicTimeSat[clinicianOpenTimeInd]=true;
								    --clinicianOpenTimeInd;
				      ...
				      if(clinicianCloseTimeInd<endOfIndex&&clinicianCloseTimeInd!=-1){
                           ...
                           while(clinicianCloseTimeInd<=endOfIndex){
                        	   satText[clinicianCloseTimeInd].setStyle("-fx-background-color :#ABEBC6");
                        	   satText[clinicianCloseTimeInd].setDisable(true);
                        	   activeClinicTimeSat[clinicianCloseTimeInd]=true;
								  ++clinicianCloseTimeInd;
							     }
    ...
    List<Date> dateList=new ArrayList<Date>();
 	public void viewBlockTime(){
		...
		System.out.println("@@@@@@@@@@@@ "+cliblock.size());
		 clinicianBlockTimeDb = new ClinicianBlockTimeEntityController().viewBydateAndClinician(dateList, ClinicianSelectController.clinician);
		
		 for(int i=0;i<clinicianBlockTimeDb.size();i++){
			 
			  if(clinicianBlockTimeDb.isEmpty()==false){
	            	 indexPro = Arrays.asList(timeSlotString).indexOf(clinicianBlockTimeDb.get(i).getBlockTime());
	            	 
	            	 if(clinicianBlockTimeDb.get(i).getBlockTimeDate().equals(date)&&indexPro!=-1){
				  ...
				  else if(clinicianBlockTimeDb.get(i).getBlockTimeDate().equals(date1)&&indexPro!=-1){
				  ...
				  else if(clinicianBlockTimeDb.get(i).getBlockTimeDate().equals(date2)&&indexPro!=-1){
				  ...
				  else if(clinicianBlockTimeDb.get(i).getBlockTimeDate().equals(date3)&&indexPro!=-1){
				  ...
				  else if(clinicianBlockTimeDb.get(i).getBlockTimeDate().equals(date4)&&indexPro!=-1){
				  ...
				  else if(clinicianBlockTimeDb.get(i).getBlockTimeDate().equals(date5)&&indexPro!=-1){
					  if(indexPro!=-1){
				  ...
				  else if(clinicianBlockTimeDb.get(i).getBlockTimeDate().equals(date6)&&indexPro!=-1){
	...
	List<ClinicianSchException> clinicianSchExcepList =new ArrayList<ClinicianSchException>(); 
 	public void viewClinicClosedDate() {
		...
		clinicianSchExcepList = new ClinicianSchExceptionEntityController().viewClinicianSchExceptionById(clinicianScheduleViewController.clinician, sunDayTextField.getText(), saturDayTextField.getText());
	 
		if(clinicianSchExcepList.size()>=7 && openEntireWeekBtnActive==0&& workUsualWeekBtnActive==0){
		...
		}else if((clinicianSchExcepList.size()<7)&&clinicianSchExcepList.size()!=0&&workUsualWeekBtnActive==0){
			
			for(int i=0;i<clinicianSchExcepList.size();i++){
				  Arrays.fill(fillAllArr, true);
				 
				if(clinicianSchExcepList.get(i).getExcepDate().equals(string2Date(sunDayTextField.getText()))){
               ...
               if(clinicianSchExcepList.get(i).getExcepDate().equals(string2Date(monDayTextField.getText()))){
            	   for(int j=0;j<lengthToGen;j++){
               ...
               if(clinicianSchExcepList.get(i).getExcepDate().equals(string2Date(tuesDayTextField.getText()))){
            	   for(int j=0;j<lengthToGen;j++){
               ...
               if(clinicianSchExcepList.get(i).getExcepDate().equals(string2Date(wednesDayTextField.getText()))){
            	   for(int j=0;j<lengthToGen;j++){
               ...
               if(clinicianSchExcepList.get(i).getExcepDate().equals(string2Date(thursDayTextField.getText()))){
            	   for(int j=0;j<lengthToGen;j++){
               ...
               if(clinicianSchExcepList.get(i).getExcepDate().equals(string2Date(friDayTextField.getText()))){
            	   for(int j=0;j<lengthToGen;j++){
               ...
               if(clinicianSchExcepList.get(i).getExcepDate().equals(string2Date(saturDayTextField.getText()))){
            	   for(int j=0;j<lengthToGen;j++){
 	  ...
 	  List<ClinicianBlockTime> clinicianBlockSchedulesList = new ArrayList<ClinicianBlockTime>();
 	  List<ClinicianBlockTime> cliBlockDelete = new ArrayList<ClinicianBlockTime>();
 	 List<ClinicianBlockTime> clinicianBlockTimeDb=null;
 	  public void blockClinicianSchedule(TextField blockedTextField,String time){
 		...
 		if(blockedTextField.getStyle().equals("-fx-background-color : #E44535")||blockedTextField.getStyle().equals("-fx-background-color : #E18080")){
 			 ...
 			 if(clinicianBlockTimeDb.get(i).getBlockTime().equals(time)&&clinicianBlockTimeDb.get(i).getBlockTimeDate().equals(dateList.get(0))){
 				cliBlockDelete.add(clinicianBlockTimeDb.get(i));
 				 }
 			 else if(clinicianBlockTimeDb.get(i).getBlockTime().equals(time)&&clinicianBlockTimeDb.get(i).getBlockTimeDate().equals(dateList.get(1))){
 				cliBlockDelete.add(clinicianBlockTimeDb.get(i));
 				 }
			
 			 else if(clinicianBlockTimeDb.get(i).getBlockTime().equals(time)&&clinicianBlockTimeDb.get(i).getBlockTimeDate().equals(dateList.get(2))){
 				cliBlockDelete.add(clinicianBlockTimeDb.get(i));
 				 }
 			 else if(clinicianBlockTimeDb.get(i).getBlockTime().equals(time)&&clinicianBlockTimeDb.get(i).getBlockTimeDate().equals(dateList.get(3))){
 				cliBlockDelete.add(clinicianBlockTimeDb.get(i));
 				 } 
 			 else if(clinicianBlockTimeDb.get(i).getBlockTime().equals(time)&&clinicianBlockTimeDb.get(i).getBlockTimeDate().equals(dateList.get(4))){
 				cliBlockDelete.add(clinicianBlockTimeDb.get(i));
 				 } 
 			else if(clinicianBlockTimeDb.get(i).getBlockTime().equals(time)&&clinicianBlockTimeDb.get(i).getBlockTimeDate().equals(dateList.get(5))){
 				cliBlockDelete.add(clinicianBlockTimeDb.get(i));
				 } 
 			else if(clinicianBlockTimeDb.get(i).getBlockTime().equals(time)&&clinicianBlockTimeDb.get(i).getBlockTimeDate().equals(dateList.get(6))){
 				cliBlockDelete.add(clinicianBlockTimeDb.get(i));
				 } 
 			else {
 				Iterator<ClinicianBlockTime> cliBl = clinicianBlockSchedulesList.iterator();
				  while (cliBl.hasNext()) {
					  ClinicianBlockTime clini = cliBl.next();
					if(clini.getBlockTime()==time){
						cliBl.remove();
 			...
 			ClinicianBlockTime clinicianBlock =  new ClinicianBlockTime();
 			clinicianBlock.setBlockTime(time);
 			clinicianBlock.setClinician(clinician);
 			  ...
 			  if(blockedTextField.getId().substring(0, 3).equals("sun")){
 				  ...
 				  Date date =  string2Date(sunDayTextField.getText());
 				 clinicianBlock.setBlockTimeDate(date);
 			 ...
 			 clinicianBlockSchedulesList.add(clinicianBlock);
 			}
 		}
 	 List<ClinicianDaysBlockTime> clinicianDaysBlock = null;
 	int blocksize=1;
 	List<ClinicianBlockDayException> blockDayList = new ArrayList<ClinicianBlockDayException>();
 	 public void checkClinicianBlockDays(){
 		
 		clinicianDaysBlock = new ClinicianDaysBlockTimeEntityController().viewByClinicianId(ClinicianSelectController.clinician);	
        System.out.println("@@@@@@@@@@@@ "+clinicianDaysBlock.size());
 		blockDayList =  new ClinicianBlockDaysExceptionEntityController().viewClinicianScheduleById(sunDayTextField.getText(),saturDayTextField.getText(), ClinicianSelectController.clinician);
        ...
        if(workUsualBtnActive==1){
 		...
 		if(clinicianDaysBlock!=null && blocksize==0){
 			for(int i=0;i<clinicianDaysBlock.size();i++){
 				if(clinicianDaysBlock.get(i).getWeekday().equals("Sunday")){
 	 				int index = Arrays.asList(timeSlotString).indexOf(clinicianDaysBlock.get(i).getStartTime());
 	 			     if(index!=-1){
 	 			    	sundayText[index].setStyle("-fx-background-color: #CA1207;"); 
 	 			     }
 	 				  
 				}	
 				if(clinicianDaysBlock.get(i).getWeekday().equals("Monday")){
 	 				int index = Arrays.asList(timeSlotString).indexOf(clinicianDaysBlock.get(i).getStartTime());
 	 				if(index!=-1){
 				...
 				if(clinicianDaysBlock.get(i).getWeekday().equals("Tuesday")){
 	 				int index = Arrays.asList(timeSlotString).indexOf(clinicianDaysBlock.get(i).getStartTime());
 	 				if(index!=-1){
 	 					tuesText[index].setStyle("-fx-background-color: #CA1207;");
 	 			     }
 	 			
 				}if(clinicianDaysBlock.get(i).getWeekday().equals("Wednesday")){
 	 				int index = Arrays.asList(timeSlotString).indexOf(clinicianDaysBlock.get(i).getStartTime());
 	 				if(index!=-1){
 				...
 				if(clinicianDaysBlock.get(i).getWeekday().equals("Thursday")){
 	 				int index = Arrays.asList(timeSlotString).indexOf(clinicianDaysBlock.get(i).getStartTime());
 	 				if(index!=-1){
 				...
 				if(clinicianDaysBlock.get(i).getWeekday().equals("Friday")){
 	 				int index = Arrays.asList(timeSlotString).indexOf(clinicianDaysBlock.get(i).getStartTime());
 	 				if(index!=-1){
 				...
 				if(clinicianDaysBlock.get(i).getWeekday().equals("Saturday")){
 	 				int index = Arrays.asList(timeSlotString).indexOf(clinicianDaysBlock.get(i).getStartTime());
 	 				if(index!=-1){
	...
	List<Date> clinicianOpenDateList = new ArrayList<Date>();
	...
	public void recurenceOfClinician(){
		
		recurenceOfProvider= new StaffSchRecurExceptionEntityController().viewStaffSchRecurExcByClinicianId(ClinicianSelectController.clinician.getId());
		...
		*/
		...
		// Set from UI to DB .
		   saveButton.setOnAction((event) -> {
			   ...
			   alert.showAndWait();
            if(clinicianBlockSchedulesList.size()>0){
            	
            	new ClinicianBlockTimeEntityController().saveOrUpdate(clinicianBlockSchedulesList);
            	clinicianBlockSchedulesList=null;
            }else if(cliBlockDelete.size()>0){
            	
            	new ClinicianBlockTimeEntityController().delete(cliBlockDelete);
            	cliBlockDelete = null;
            }
            if(offWeekCheck==1){
            	List<ClinicianSchException> cliSch = new ArrayList<ClinicianSchException>();
            	for(int i=0;i<7;i++){
            	ClinicianSchException cli = new ClinicianSchException();
            	cli.setClinician(clinician);
            	cli.setExcepDate(dateList.get(i));
            	cliSch.add(cli);
            	}
            	 new ClinicianSchExceptionEntityController().saveOrUpdate(cliSch);
            }
            if(offWeekCheck==0){
            	...
            	new ClinicianSchExceptionEntityController().deleteBetweenDates(stD,stEnd,clinician);
            	new ClinicianBlockTimeEntityController().deleteBlockTimeByDate(stD, stEnd, clinician);
            	
            	new ClinicianBlockDaysExceptionEntityController().saveOrUpdate(dateBlockEx,clinician);
			...
			if(ifCheckClicked==1){
				...
				if(getSelectedCheckList.get(0)!= openCheckBoxCollumn1.isSelected()){
					...
					clinicianOpenDateList.add(string2Date(sunDayTextField.getText()));
				}
				
				if(getSelectedCheckList.get(1)!= openCheckBoxCollumn2.isSelected()){
					clinicianOpenDateList.add(string2Date(monDayTextField.getText()));
				}
				if(getSelectedCheckList.get(2)!= openCheckBoxCollumn3.isSelected()){
					
					clinicianOpenDateList.add(string2Date(tuesDayTextField.getText()));
				}
				if(getSelectedCheckList.get(3)!= openCheckBoxCollumn4.isSelected()){
					clinicianOpenDateList.add(string2Date(wednesDayTextField.getText()));
					
				}
				if(getSelectedCheckList.get(4)!= openCheckBoxCollumn5.isSelected()){
					clinicianOpenDateList.add(string2Date(thursDayTextField.getText()));
					
				}
				if(getSelectedCheckList.get(5)!= openCheckBoxCollumn6.isSelected()){
					clinicianOpenDateList.add(string2Date(friDayTextField.getText()));
					
				}
				if(getSelectedCheckList.get(6)!= openCheckBoxCollumn7.isSelected()){
					clinicianOpenDateList.add(string2Date(saturDayTextField.getText()));
					
				}
				
				for(int i=0;i<clinicianOpenDateList.size();i++){
					ClinicianSchException clinicianSchException = new ClinicianSchException();
					clinicianSchException.setClinician(clinician);
					clinicianSchException.setExcepDate(clinicianOpenDateList.get(i));
					 new ClinicianSchExceptionEntityController().saveOrUpdateNoDuplicate(clinicianSchException);
			...
			if(workUsualBtnActive==1){
				...
				blocksize=1;
				new ClinicianBlockDaysExceptionEntityController().delete(sunDayTextField.getText(), saturDayTextField.getText(), clinician);
				Date stD = string2Date(sunDayTextField.getText());
            	Date stEnd =  string2Date(saturDayTextField.getText());
            	new ClinicianSchExceptionEntityController().deleteBetweenDates(stD,stEnd,clinician);
			}
