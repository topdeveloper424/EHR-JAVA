 ...
 *Module Name:
 *Parameter Definition: Type object of FoodOrSubstanceInputController Class
 *Description: foodOrSubstance.fxml GUI Controller class
 ...
 */
public class FoodOrSubstanceInputController implements Initializable {
	...
	@FXML
	private CheckBox utricariaCheck;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		medicationSearchBtn.setOnAction((event)->{
			...
			try {
				...
				FoodAllergyViewController foodAllergyViewController =  (FoodAllergyViewController) new FXFormCommonUtilities().displayForm(formName,
						formTitle);
				foodAllergyViewController.setFoodOrSubstanceInputController(this);
		...
		DoneButton.setOnAction((event) -> {
			...
			if (anaphylaxisCheck.isSelected() || VomitingCheck.isSelected() || utricariaCheck.isSelected()
					|| flushingCheck.isSelected() || feverCheck.isSelected() || pruriticCheck.isSelected()
					|| seizureCheck.isSelected() || nauseaCheck.isSelected()) {

				StringBuilder str11 = new StringBuilder(pMHAllergyInputController.str);
				str11.append("* Select Any Food or Substance, reacted with ");
				pMHAllergyInputController.str = str11.toString();

				if (anaphylaxisCheck.isSelected()) {

					StringBuilder str1 = new StringBuilder(pMHAllergyInputController.str);
					str1.append("Food anaphylaxis, ");
					pMHAllergyInputController.str = str1.toString();
				...
				if (VomitingCheck.isSelected()) {
					...
					StringBuilder str1 = new StringBuilder(pMHAllergyInputController.str);
					str1.append("Vomiting, ");
					pMHAllergyInputController.str = str1.toString();

				}
				if (utricariaCheck.isSelected()) {
