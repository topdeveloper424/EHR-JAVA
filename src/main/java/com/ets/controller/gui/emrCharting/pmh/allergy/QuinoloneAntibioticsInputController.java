 ...
 *Module Name:
 *Parameter Definition: Type object of QuinoloneAntibioticsInputController Class
 *Description: quinoloneAntibiotics.fxml GUI Controller class
...
public class QuinoloneAntibioticsInputController implements Initializable {
...
public void initialize(URL location, ResourceBundle resources) {
	...
	AllergyCategory allergyCategories = new AllergyCategoryEntityController().searchByDescrip("quinolone antibiotics");
	...
	medicationSearchBtn.setOnAction((event) -> {
		...
		try {
			...
			allergyCategoryViewController.setQuinoloneAntibioticsInputController(this);
	...
	DoneButton.setOnAction((event) -> {
		...
		if(anaphylaxisCheck.isSelected()|| feverCheck.isSelected()||dizzinessCheck.isSelected()
				||flushingCheck.isSelected()||hivesCheck.isSelected()|| nauseaCheck.isSelected()
				||headacheCheck.isSelected()|| rashCheck.isSelected()){
