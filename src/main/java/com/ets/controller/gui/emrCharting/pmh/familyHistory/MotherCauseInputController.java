...
public class MotherCauseInputController implements Initializable {
	
	  @FXML
	    private RadioButton BreastCancerRadio;
	    ...
	    @FXML
	    private RadioButton OvarianCancerRadio;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		doneBtn.setOnAction((event) -> {
			...
			if(BreastCancerRadio.isSelected()){
				
				
				StringBuilder str1 = new StringBuilder(pMHFamilyHistoryInputController.str);
				str1.append("Mother died from breast cancer ");
				...
				StringBuilder str1 = new StringBuilder(pMHFamilyHistoryInputController.str);
				str1.append("Mother died from CVA ");
				pMHFamilyHistoryInputController.str = str1.toString();
				...
				StringBuilder str1 = new StringBuilder(pMHFamilyHistoryInputController.str);
				str1.append("Mother died from diabetes ");
				pMHFamilyHistoryInputController.str = str1.toString();
				
				
			}if(OvarianCancerRadio.isSelected()){
				
				
				StringBuilder str1 = new StringBuilder(pMHFamilyHistoryInputController.str);
				str1.append("Mother died from ovarian cancer  ");
				pMHFamilyHistoryInputController.str = str1.toString();
				...
				StringBuilder str1 = new StringBuilder(pMHFamilyHistoryInputController.str);
				str1.append("Mother died from sucide ");
				pMHFamilyHistoryInputController.str = str1.toString();
				...
				StringBuilder str1 = new StringBuilder(pMHFamilyHistoryInputController.str);
				str1.append("Mother died from CAD");
				pMHFamilyHistoryInputController.str = str1.toString();
