...
public class PullingPoundsInputController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		doneBtn.setOnAction((event) -> {
			...
			if(liftingText.getText().length() > 0){
				...
				str11.append("No pulling more than " +liftingText.getText() +" pounds " );
