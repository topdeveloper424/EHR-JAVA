 ...
 *Description: kneeROMRight.fxml Controller class
...
public class KneeRomRightInputController implements Initializable{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		doneBtn.setOnAction((event) -> {
			...
			if (flexionText.getText().length() > 0) {
				...
				str1.append("\nRight Knee: Flexion"+flexionText.getText()+" degrees (NL-130 degrees)");
			...
			if (extensionText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneKneeInputController.str);
				str1.append("\nRight Knee: Extension"+extensionText.getText()+"degrees (NL-10 degrees)");
				examMusculotoneKneeInputController.str = str1.toString();
			...
			if (hyperextensionText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneKneeInputController.str);
				str1.append("\nRight Knee: Hyperextension"+hyperextensionText.getText()+" degrees (NL-15 degrees). ");
				examMusculotoneKneeInputController.str = str1.toString();
