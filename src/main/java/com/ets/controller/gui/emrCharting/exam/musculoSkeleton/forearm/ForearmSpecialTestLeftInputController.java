 ...
 *Module Name:
 *Parameter Definition: Type object of ForearmSpecialTestLeftInputController Class
...
public class ForearmSpecialTestLeftInputController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		doneBtn.setOnAction((event) -> {
			...
			examComp.append("\n\nSPECIAL TESTS:\nLeft wrist and hand - the following special tests were performed: ");
