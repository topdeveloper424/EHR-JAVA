 ...
 *Module Name:
 *Parameter Definition: Type object of SelectMedicationInputController Class
 *Description: sulfaDrugs.fxml GUI Controller class
 ...
 */
public class SelectMedicationInputController implements Initializable {
	  @FXML
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		medicationSearchBtn.setOnAction((event)->{
			...
			try {
				...
				MedicationCodeViewController medicationCodeViewController =  (MedicationCodeViewController) new FXFormCommonUtilities().displayForm(formName,
						formTitle);
				medicationCodeViewController.setSelectMedicationInputController(this);
		...
		if(anaphylaxisCheck.isSelected() || diarrheaCheck.isSelected()
				...
				|| urticariaCheck.isSelected() || localizedCheck.isSelected() ){
