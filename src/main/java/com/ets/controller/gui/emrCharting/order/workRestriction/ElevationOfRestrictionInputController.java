...
public class ElevationOfRestrictionInputController implements Initializable {
		...
		doneBtn.setOnAction((event) -> {
			...
			orderWorkRestrictionInputController.str = ctScanStr.toString();
				...
				if(elevationText.getText().length() > 0){
					...
					str11.append("Patient must keep affected leg elevated " +elevationText.getText() +" hours per day. " );
