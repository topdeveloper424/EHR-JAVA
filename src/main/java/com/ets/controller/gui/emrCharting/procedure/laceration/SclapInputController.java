...
public class SclapInputController implements Initializable {
	  ...
	  @FXML
	    ...
	    @FXML
	    private RadioButton stitchesRadio;

	    @FXML
	    private ToggleGroup sta;

	    @FXML
	    private RadioButton staplesRadio;
	...
	public void initialize(URL location, ResourceBundle resources) {
		doneBtn.setOnAction((event) -> {
			...
			if (simple0Radio.isSelected()) {
				...
				str1.append("I conducted a simple (0 - 2.5) laceration repair procedure on the scalp. ");
				medicalProcedureInputController.str = str1.toString();
				
			}if (simple26Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a simple Simple (2.6 - 7.5) laceration repair procedure on the scalp. ");
				medicalProcedureInputController.str = str1.toString();

			}if (intermidate0Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a Intermidiate(0 - 2.5) laceration repair procedure on the scalp. ");
				medicalProcedureInputController.str = str1.toString();
				
			}if (complex26Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a complex (2.6 - 7.5) laceration repair procedure on the scalp. ");
				medicalProcedureInputController.str = str1.toString();
				
			}if (intermidate26Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a Intermidiate(2.6 - 5.0) laceration repair procedure on the scalp. ");
				medicalProcedureInputController.str = str1.toString();

			}if (complex1Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a complex (1.1 - 2.5) laceration repair procedure on the scalp. ");
				medicalProcedureInputController.str = str1.toString();
			...
			if (additionalLacerationText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append(additionalLacerationText.getText() +".");
				medicalProcedureInputController.str = str1.toString();
			...
			if (suturesCheckBox.isSelected() || staplesCheckBox.isSelected()
