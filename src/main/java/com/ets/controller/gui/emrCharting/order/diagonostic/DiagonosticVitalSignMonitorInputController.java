...
public class DiagonosticVitalSignMonitorInputController implements Initializable {
    ...
    @FXML
    private CheckBox fetalHeartCheck;

    @FXML
    private CheckBox bodyFatCheck;
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		doneBtn.setOnAction((event) -> {
			...
			if(pulseCheck.isSelected() 
					...
					|| fetalHeartCheck.isSelected() || bodyFatCheck.isSelected()){
				
				StringBuilder str = new StringBuilder(orderDiagonosticTestInputController.str);
				str.append("The following additional vital signs were monitored in the office: ");
