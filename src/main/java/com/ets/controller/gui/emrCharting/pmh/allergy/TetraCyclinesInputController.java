 ...
 *Module Name:
 *Parameter Definition: Type object of TetraCyclinesInputController Class
 *Description: tetraCyclines.fxml GUI Controller class
 ...
 */
public class TetraCyclinesInputController implements Initializable {
...
public void initialize(URL location, ResourceBundle resources) {
	...
	AllergyCategory allergyCategories = new AllergyCategoryEntityController().searchByDescrip("tetracyclines");
	...
	medicationSearchBtn.setOnAction((event) -> {
		...
		try {
			...
			allergyCategoryViewController.setTetraCyclinesInputController(this);
	...
	if(anaphylaxisCheck.isSelected() || dizzinessCheck.isSelected()
			|| feverCheck.isSelected() || flushingCheck.isSelected()
			|| urticariaCheck.isSelected() || nauseaCheck.isSelected()
			|| rashCheck.isSelected() || seizuresCheck.isSelected() ){
