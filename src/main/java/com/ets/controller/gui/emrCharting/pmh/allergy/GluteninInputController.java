 ...
 *Module Name:
 *Parameter Definition: Type object of GluteninInputController Class
 *Description: glutenin.fxml GUI Controller class
 ...
 */
public class GluteninInputController implements Initializable {
	...
	@FXML
	private CheckBox abdominalbloatingCheck;

	@FXML
	private CheckBox abdominalpainCheck;

	@FXML
	private CheckBox dermatitisCheck;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		medicationSearchBtn.setOnAction((event) -> {
			...
			try {
				...
				FoodAllergyViewController foodAllergyViewController = (FoodAllergyViewController) new FXFormCommonUtilities()
						.displayForm(formName, formTitle);
				foodAllergyViewController.setGluteninInputController(this);
		...
		DoneButton.setOnAction((event) -> {
			...
			if (abdominalbloatingCheck.isSelected() || abdominalpainCheck.isSelected() || dermatitisCheck.isSelected()
					|| diarrheaCheck.isSelected() || itchingCheck.isSelected()) {
				...
				if (abdominalbloatingCheck.isSelected()) {

					StringBuilder str1 = new StringBuilder(pMHAllergyInputController.str);
					str1.append("abdominal bloating, ");
					pMHAllergyInputController.str = str1.toString();

				}
				if (abdominalpainCheck.isSelected()) {

					StringBuilder str1 = new StringBuilder(pMHAllergyInputController.str);
					str1.append("abdominal pain, ");
					pMHAllergyInputController.str = str1.toString();

				}
				if (dermatitisCheck.isSelected()) {

					StringBuilder str1 = new StringBuilder(pMHAllergyInputController.str);
					str1.append("dermatitis, ");
					pMHAllergyInputController.str = str1.toString();
