 ...
 *Module Name:
 *Parameter Definition: Type object of ShellfishInputController Class
 *Description: shellfish.fxml GUI Controller class
 ...
 */
public class ShellfishInputController implements Initializable {
    ...
    @FXML
    private CheckBox congetionCheck;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		medicationSearchBtn.setOnAction((event)->{
			...
			try {
				...
				FoodAllergyViewController foodAllergyViewController =  (FoodAllergyViewController) new FXFormCommonUtilities().displayForm(formName,
						formTitle);
				foodAllergyViewController.setShellfishInputController(this);
		...
		if(anaphylaxisCheck.isSelected() || congetionCheck.isSelected()
				|| diarrheaCheck.isSelected() || flushingCheck.isSelected()
				|| urticariaCheck.isSelected() || nauseaCheck.isSelected()
				|| swellngheck.isSelected() || tinglingCheck.isSelected() ){
