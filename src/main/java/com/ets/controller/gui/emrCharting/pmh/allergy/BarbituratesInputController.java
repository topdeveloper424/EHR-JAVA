 ...
 *Module Name:
 *Parameter Definition: Type object of BarbituratesInputController Class
 *Description: barbiturates.fxml GUI Controller class
 ...
 */
public class BarbituratesInputController implements Initializable {
    ...
    @FXML
    private CheckBox pruriticCheck;
    ...
    public void initialize(URL location, ResourceBundle resources) {
	 AllergyCategory allergyCategories =  new AllergyCategoryEntityController().searchByDescrip("Barbiturates");
	...
	medicationSearchBtn.setOnAction((event)->{
			...
			try {
				...
				AllergyCategoryViewController allergyCategoryViewController =  (AllergyCategoryViewController) new FXFormCommonUtilities().displayForm(formName,
						formTitle);
				allergyCategoryViewController.setBarbituratesInputController(this);
	...
	if(anaphylaxisCheck.isSelected() || dizzinessCheck.isSelected()|| feverCheck.isSelected()
	|| flushingCheck.isSelected()||urticariaCheck.isSelected()||nauseaCheck.isSelected()||
	pruriticCheck.isSelected()||respiratoryCheck.isSelected()){
		...
		if (anaphylaxisCheck.isSelected()) {
			...
			StringBuilder str1 = new StringBuilder(pMHAllergyInputController.str);
			str1.append("respiratory distress, ");
			pMHAllergyInputController.str = str1.toString();
