 ...
 *Module Name:
 *Parameter Definition: Type object of ElbowSpecialTestLeftInputController Class
 *Description: ElbowSpecialTestLeft GUI Controller class
 ...
 */
public class ElbowSpecialTestLeftInputController implements Initializable{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		doneBtn.setOnAction((event) -> {
			...
			examComp.append("\n\nSPECIAL TESTS: \nLeft elbow - the following special tests were performed:\n ");
			...
			if (elbowPositive.isSelected()) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneElbowInputController.str);
				str1.append("Elbow flexion test possitive.");
				examMusculotoneElbowInputController.str = str1.toString();
