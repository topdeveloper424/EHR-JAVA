...
public class WbcResultInputController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		doneBtn.setOnAction((event) -> {
			...
			if (wbcText.getText().length() > 0) {

				StringBuilder str1 = new StringBuilder(resultInputController.str);
				str1.append("Results of WBC are: " +wbcText.getText() +" 10^3 cells /mm3.");
