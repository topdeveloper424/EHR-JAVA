 ...
 *Module Name:
 *Parameter Definition: Type object of MMRVaccineInputController Class
 *Description: MMRVaccine.fxml GUI Controller class
...
public class MMRVaccineInputController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		medicationSearchBtn.setOnAction((event)->{
			...
			try {
				...
				MedicalActivityViewController medicalActivityViewController =  (MedicalActivityViewController) new FXFormCommonUtilities().displayForm(formName,
						formTitle);
				medicalActivityViewController.setMmrVaccineInputController(this);
		...
		DoneButton.setOnAction((event) -> {
			...
			if (localizedCheck.isSelected() || pruriticCheck.isSelected() || feverCheck.isSelected()
					|| flushingCheck.isSelected() || seizureCheck.isSelected()) {
