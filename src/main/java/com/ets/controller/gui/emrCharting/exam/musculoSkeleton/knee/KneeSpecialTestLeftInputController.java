 ...
 *Module Name:
 *Parameter Definition: Type object of KneeSpecialTestLeftInputController Class
 *Description: kneeSpecialTestleft.fxml Controller class
...
public class KneeSpecialTestLeftInputController implements Initializable{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		doneBtn.setOnAction((event) -> {
			...
			examComp.append("\n\nSPECIAL TESTS:\nLeft Knee- the following special tests were performed: ");
