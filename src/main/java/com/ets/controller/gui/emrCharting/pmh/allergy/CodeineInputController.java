 ...
 *Module Name:
 *Parameter Definition: Type object of CodeineInputController Class
 *Description: codeine.fxml GUI Controller class
 ...
 */
public class CodeineInputController implements Initializable {
...
public void initialize(URL location, ResourceBundle resources) {
	Medication medication = new MedicationEntityController().searchByName("Codeine");
	...
	medicationSearchBtn.setOnAction((event) -> {
		try {
			...
			MedicationCodeViewController medicationCodeViewController =  (MedicationCodeViewController) new FXFormCommonUtilities().displayForm(formName,
					formTitle);
			medicationCodeViewController.setCodeineInputController(this);
