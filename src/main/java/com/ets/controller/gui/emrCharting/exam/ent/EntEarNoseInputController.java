 ...
 *Module Name:
 *Parameter Definition: Type object of EntEarNoseInputController Class
 *Description: entEar&Nose4.fxml Controller class
...
public class EntEarNoseInputController implements Initializable{
...
if(canalLeftAllNormalCkeckBox.isSelected()){
			...
			if(tympanicAllNormalCheck.isSelected()) {
				...
				if (tympanicBloodCheck.isSelected() || tympanicBulgingCheck.isSelected() || tympanicErythematousCheck.isSelected() || tympanicRetractedCheck.isSelected()
						...
						|| tympanicAllNormalCheck.isSelected() || tympanicPerforationCheck.isSelected() || tympanicPETubeCheck.isSelected()) {
...
if (noseAllNormalCkeckBox.isSelected()) {
			...
			if (nasalAllNormalCkeckBox.isSelected()) {
				...
				StringBuilder str1 = new StringBuilder(examEntInputController.str);
				str1.append("Nasal mucosa normal, septum normal, turbinates normal.");
				examEntInputController.str = str1.toString();
				
			}else{
				
				if (nasalEpistaxisCkeckBox.isSelected() || nasalHyperemicCkeckBox.isSelected() || nasalLeftCkeckBox.isSelected()
						|| nasalPolypCkeckBox.isSelected() || nasalRhinorrheaCkeckBox.isSelected() || nasalRightCkeckBox.isSelected()) {
					
					StringBuilder str11 = new StringBuilder(examEntInputController.str);
					str11.append("Nose: Nasal mucosa ");
					examEntInputController.str = str11.toString();
			...
			if (sptumhematomaCkeckBox.isSelected() || sptumMarkedDeviationCkeckBox.isSelected() || sptumNormalCkeckBox.isSelected()
					|| sptumPerforatedCkeckBox.isSelected()) {
			...
			if (turbinatesBoggyCheck.isSelected() || turbinatesEnlargedCheck.isSelected() || turbinatesInflamedCheck.isSelected()
					|| turbinatesNormalCheck.isSelected() || turbinatesSwollenlCheck.isSelected()) {
