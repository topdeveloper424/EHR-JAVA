...
public class HandUsageInputController implements Initializable {
		...
		doneBtn.setOnAction((event) -> {
			...
			orderWorkRestrictionInputController.str = ctScanStr.toString();
				...
				if(rightRadio.isSelected()){
					...
					str11.append("Patient should not use right hand.");
					...
					str1.append("Patient should not use left hand.");
