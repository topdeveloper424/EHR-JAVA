 ...
 *Module Name:
 *Parameter Definition: Type object of HipRomLeftInputController Class
 *Description: HipROMLeft.fxml Controller class
...
public class HipRomLeftInputController implements Initializable{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		doneBtn.setOnAction((event) -> {
			...
			if (flexionFlexeText.getText().length() > 0) {
				...
				str1.append("\nLeft Hip: Flexion W/Knee Flexed"+flexionFlexeText.getText()+"degrees (NL-120 degrees)");
			...
			if (FlexionKneeText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneHipInputController.str);
				str1.append("\n Left Hip: Flexion W/Knee Extended "+FlexionKneeText.getText()+"degrees (NL-90 degrees)");
				examMusculotoneHipInputController.str = str1.toString();
			...
			if (LeftExtensionText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneHipInputController.str);
				str1.append("\n Left Hip: Extension"+LeftExtensionText.getText()+"degrees (NL-30 degrees)");
				examMusculotoneHipInputController.str = str1.toString();
			...
			if (abductionText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneHipInputController.str);
				str1.append("\nLeft Hip: Abduction "+abductionText.getText()+" degrees (NL-45 degrees)");
				examMusculotoneHipInputController.str = str1.toString();
			...
			if (adductionText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneHipInputController.str);
				str1.append(" \nLeft Hip: Adduction"+adductionText.getText()+"degrees (NL-30 degrees)");
				examMusculotoneHipInputController.str = str1.toString();
			...
			if (internalText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneHipInputController.str);
				str1.append("\nLeft Hip: Internal Rotation"+internalText.getText()+"degrees (NL-40 degrees)");
				examMusculotoneHipInputController.str = str1.toString();
			...
			if (externalText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneHipInputController.str);
				str1.append(" \nLeft Hip: External Rotation "+externalText.getText()+" degrees (NL-45 degrees).");
				examMusculotoneHipInputController.str = str1.toString();
