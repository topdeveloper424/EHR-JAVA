 ...
 *Module Name:
 *Parameter Definition: Type object of ForearmRomWristRightInputController Class
 *Description: ForearmROMWristRight.fxml Controller class
...
public class ForearmRomWristRightInputController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		doneBtn.setOnAction((event) -> {
			...
			if (flexionText.getText().length() > 0) {
				...
				str1.append("Right Wrist: Flexion "+flexionText.getText()+" degrees (NL-90 degrees)");
			...
			if (extensionText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneForearmInputController.str);
				str1.append("Right Wrist: Extension "+extensionText.getText()+" degrees (NL-70 degrees)");
				examMusculotoneForearmInputController.str = str1.toString();
			...
			if (radialText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneForearmInputController.str);
				str1.append("Right Wrist: Radial Deviation "+radialText.getText()+" degrees (NL-20 degrees)");
				examMusculotoneForearmInputController.str = str1.toString();
			...
			if (ulnarText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneForearmInputController.str);
				str1.append("Right Wrist: Ulnar Deviation "+ulnarText.getText()+" degrees (NL-55 degrees).");
				examMusculotoneForearmInputController.str = str1.toString();
