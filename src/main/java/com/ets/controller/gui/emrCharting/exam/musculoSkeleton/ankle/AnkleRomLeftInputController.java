 ...
 *Module Name:
 *Parameter Definition: Type object of AnkleRomLeftInputController Class
...
public class AnkleRomLeftInputController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		doneBtn.setOnAction((event) -> {
			...
			if (dorsiflexionText.getText().length() > 0) {
				...
				str1.append("\nLeft Ankle: Dorsiflexion "+dorsiflexionText.getText()+" degrees (NL-20 degrees)");
			...
			if (planterText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneAnkleInputController.str);
				str1.append("\nLeft Ankle: Plantar Flexion "+planterText.getText()+" degrees (NL-45 degrees)");
				examMusculotoneAnkleInputController.str = str1.toString();
			...
			if (inversionText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneAnkleInputController.str);
				str1.append("\nLeft Ankle: Inversion "+inversionText.getText()+" degrees (NL-30 degrees)");
				examMusculotoneAnkleInputController.str = str1.toString();
			...
			if (eversionText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneAnkleInputController.str);
				str1.append("\nLeft Ankle: Eversion "+eversionText.getText()+" degrees (NL-20 degrees).");
				examMusculotoneAnkleInputController.str = str1.toString();
