 ...
 *Module Name:
 *Parameter Definition: Type object of MedicationCategoryInputController Class
 *Description: medicationCategory.fxml GUI Controller class
 ...
 */
public class MedicationCategoryInputController implements Initializable {
...
private PMHAllergyInputController pMHAllergyInputController;
	...
	public void initialize(URL location, ResourceBundle resources) {
		allergyReactionText.setText("* Select Any Medication");
		...
		medicationSearchBtn.setOnAction((event)->{
			...
			try {
				...
				MedicationCodeViewController medicationCodeViewController =  (MedicationCodeViewController) new FXFormCommonUtilities().displayForm(formName,
						formTitle);
				medicationCodeViewController.setMedicationCategoryInputController(this);
		...
		if(anaphylaxisCheck.isSelected() || diarrheaCheck.isSelected()
				|| dizzinessCheck.isSelected() || feverCheck.isSelected()
				|| flushingCheck.isSelected() || headacheCheck.isSelected()
				|| itchingCheck.isSelected() || nauseaCheck.isSelected() ){
