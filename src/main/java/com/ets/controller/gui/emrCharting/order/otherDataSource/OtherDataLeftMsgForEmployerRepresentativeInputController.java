...
public class OtherDataLeftMsgForEmployerRepresentativeInputController implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		doneBtn.setOnAction((event) -> {
			...
			orderOtherDataSourceInputController.str = ctScanStr.toString();
				...
				str11.append("Left message for the following employer representative regarding patient's injury, evaluation, or work status " +nameText.getText() +". " );
