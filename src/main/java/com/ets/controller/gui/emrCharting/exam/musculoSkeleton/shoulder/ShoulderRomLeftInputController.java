 ...
 *Module Name:
 *Parameter Definition: Type object of ShoulderRomLeftInputController Class
 *Description: shoulderROMLeft GUI Controller class
 ...
 */
public class ShoulderRomLeftInputController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		doneBtn.setOnAction((event) -> {
			...
			if (flexionText.getText().length() > 0) {
				...
				str1.append("\nLeft Shoulder: Flexion "+flexionText.getText()+"degrees (NL-80 degrees)");
			...
			if (extensionText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneShoulderInputController.str);
				str1.append("\nLeft Shoulder: Extension"+rightLateralText.getText()+"degrees (NL-50 degrees)");
				examMusculotoneShoulderInputController.str = str1.toString();
			...
			if (rightRatationText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneShoulderInputController.str);
				str1.append("\nLeft Shoulder: Abduction "+LeftLateralText.getText()+" degrees (NL-180 degrees)");
				examMusculotoneShoulderInputController.str = str1.toString();
			...
			if (leftRatationText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneShoulderInputController.str);
				str1.append("\nLeft Shoulder: Adduction"+flexionText.getText()+"degrees (NL-50 degrees)");
				examMusculotoneShoulderInputController.str = str1.toString();
			...
			if (rightLateralText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneShoulderInputController.str);
				str1.append("\nLeft Shoulder: Internal Rotation"+rightLateralText.getText()+"degrees (NL-90 degrees)");
				examMusculotoneShoulderInputController.str = str1.toString();
			...
			if (LeftLateralText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneShoulderInputController.str);
				str1.append("\nLeft Shoulder: External Rotation "+LeftLateralText.getText()+" degrees (NL-90 degrees).");
				examMusculotoneShoulderInputController.str = str1.toString();
