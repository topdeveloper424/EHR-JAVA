 ...
 *Module Name:
 *Parameter Definition: Type object of ElboeRomLeftInputController Class
 *Description: ElboeRomLeft GUI Controller class
 ...
 */
public class ElboeRomLeftInputController implements Initializable{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		doneBtn.setOnAction((event) -> {
			...
			if (flexionText.getText().length() > 0) {
				...
				str1.append("Left Elbow: Flexion " +flexionText.getText()+ " degrees (NL-160 degrees)");
			...
			if (extensionText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneElbowInputController.str);
				str1.append("Left Elbow: Extension "+extensionText.getText()+" degrees (NL-5 degrees)");
				examMusculotoneElbowInputController.str = str1.toString();
			...
			if (supinationText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneElbowInputController.str);
				str1.append("Left Elbow: Supination "+supinationText.getText()+" degrees (NL-90 degrees)");
				examMusculotoneElbowInputController.str = str1.toString();
			...
			if (pronationText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneElbowInputController.str);
				str1.append(" Left Elbow: Pronation  "+pronationText.getText()+" degrees (NL-90 degrees).");
				examMusculotoneElbowInputController.str = str1.toString();
