...
public class NoseInputController implements Initializable {
	 ...
	 @FXML
	    ...
	    @FXML
	    private CheckBox cartilageCkeckBox;
	    ...
	    @FXML
	    private RadioButton complex51Radio;
	...
	public void initialize(URL location, ResourceBundle resources) {
		doneBtn.setOnAction((event) -> {
			...
			if (simple0Radio.isSelected()) {
				...
				str1.append("I conducted a simple (0 - 2.5) laceration repair procedure on the nose. ");
				medicalProcedureInputController.str = str1.toString();
				
			}if (simple26Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a simple Simple (2.6 - 5.0) laceration repair procedure on the nose. ");
				medicalProcedureInputController.str = str1.toString();

			}if (simple51Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a simple Simple(5.1 - 7.5) laceration repair procedure on the nose. ");
				medicalProcedureInputController.str = str1.toString();

			}if (intermidate0Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a Intermidiate(0 - 2.5) laceration repair procedure on the nose. ");
				medicalProcedureInputController.str = str1.toString();
				
			}if (intermidate51Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a Intermidiate (5.1 - 7.5) laceration repair procedure on the nose. ");
				medicalProcedureInputController.str = str1.toString();

			}if (complex51Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a complex (2.6 - 7.5) laceration repair procedure on the nose. ");
				medicalProcedureInputController.str = str1.toString();
				
			}if (intermidate26Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a Intermidiate(2.6 - 5.0) laceration repair procedure on the nose. ");
				medicalProcedureInputController.str = str1.toString();

			}if (complex1Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a complex (0 - 1.0) laceration repair procedure on the nose. ");
				medicalProcedureInputController.str = str1.toString();

			}if (complex26Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a complex (1.1 - 2.5) laceration repair procedure on the nose. ");
				medicalProcedureInputController.str = str1.toString();
			...
			if (epidermisCkeckBox.isSelected() || dermistCkeckBox.isSelected()
					|| cartilageCkeckBox.isSelected() || iaggedCkeckBox.isSelected()
				...
				}if (cartilageCkeckBox.isSelected()) {
