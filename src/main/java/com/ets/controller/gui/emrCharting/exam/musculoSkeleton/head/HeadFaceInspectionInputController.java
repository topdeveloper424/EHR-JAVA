 ...
 *Module Name:
 *Parameter Definition: Type object of HeadFaceInspectionInputController Class
 *Description: headFaceInspection GUI Controller class
 ...
 */
public class HeadFaceInspectionInputController implements Initializable{
    ...
    @FXML
    private CheckBox hearOrFaceNormalCheck1;
    
    @FXML
    private RadioButton otherMassesCheck;

    @FXML
    private ToggleGroup Other;

    @FXML
    private RadioButton otherLacerationsCheck;

    @FXML
    private RadioButton otherEcchymosisCheck;

    @FXML
    private RadioButton otherContusionsCheck;

    @FXML
    private RadioButton otherAbrasionsCheck;

    @FXML
    private CheckBox otherNormalsCheck;
