...
public class SchoolExcuseUConlyInputController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		doneBtn.setOnAction((event) -> {
			...
			if(startingText.getText().length() > 0){
				
				StringBuilder str11 = new StringBuilder(orderWorkRestrictionInputController.str);
				str11.append("Patient is excused from school starting: " +startingText.getText() +". " );
				orderWorkRestrictionInputController.str = str11.toString();
				
			}
			
			if(unitText.getText().length() > 0){
				
				StringBuilder str11 = new StringBuilder(orderWorkRestrictionInputController.str);
				str11.append(" until " +unitText.getText() +"This encounter form is to serve as a \"Doctors Note\"  A copy of this form should be given to your school. " );
				orderWorkRestrictionInputController.str = str11.toString();
