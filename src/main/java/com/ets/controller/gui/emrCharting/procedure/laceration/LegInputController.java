...
public class LegInputController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		doneBtn.setOnAction((event) -> {
			...
			if (simple0Radio.isSelected()) {
				...
				str1.append("I conducted a simple (0 - 2.5) laceration repair procedure on the leg. ");
				medicalProcedureInputController.str = str1.toString();
				
			}if (simple26Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a simple (2.6 - 7.5) laceration repair procedure on the leg. ");
				medicalProcedureInputController.str = str1.toString();

			}if (intermidate0Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a intermediate  (0 - 2.5) laceration repair procedure on the leg. ");
				medicalProcedureInputController.str = str1.toString();
				
			}if (complex1Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a complex (1.1 - 2.5) laceration repair procedure on the leg. ");
				medicalProcedureInputController.str = str1.toString();

			}if (complex26Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a complex (2.6 - 7.5) laceration repair procedure on the leg. ");
				medicalProcedureInputController.str = str1.toString();
				
			}if (intermidate26Radio.isSelected()) {

				StringBuilder str1 = new StringBuilder(medicalProcedureInputController.str);
				str1.append("I conducted a intermediate  (2.6 - 7.5) laceration repair procedure on the leg. ");
				medicalProcedureInputController.str = str1.toString();
