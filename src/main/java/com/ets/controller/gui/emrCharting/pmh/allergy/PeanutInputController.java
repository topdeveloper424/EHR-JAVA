 ...
 *Module Name:
 *Parameter Definition: Type object of PeanutInputController Class
 *Description: peanut.fxml GUI Controller class
...
public class PeanutInputController implements Initializable {
    ...
    @FXML
    private CheckBox SwelllingCheck;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		medicationSearchBtn.setOnAction((event)->{
			...
			try {
				...
				FoodAllergyViewController foodAllergyViewController =  (FoodAllergyViewController) new FXFormCommonUtilities().displayForm(formName,
						formTitle);
				foodAllergyViewController.setPeanutInputController(this);
		...
		if(anaphylaxisCheck.isSelected() || diarrheaCheck.isSelected()|| congestionCheck.isSelected()
		|| flushingCheck.isSelected()||urticariaCheck.isSelected()||nauseaCheck.isSelected()||
		diarrheaCheck.isSelected()||nauseaCheck.isSelected()||SwelllingCheck.isSelected()||tinglingCheck.isSelected()){
