 ...
 *Module Name:
 *Parameter Definition: Type object of AnkleFootSpecialTestRightInputController Class
...
public class AnkleFootSpecialTestRightInputController implements Initializable{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		doneBtn.setOnAction((event) -> {
			...
			examComp.append("\n\nSPECIAL TESTS:\n Right ankle and foot - the following special tests were performed: ");
