 ...
 *Module Name:
 *Parameter Definition: Type object of EyeVisualAcuityCorrectInputController Class
 *Description: EyeVisualAcuityCorrect GUI Controller class
 ...
 */
public class EyeVisualAcuityCorrectInputController implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		doneBtn.setOnAction((event)->
		{
			...
			if (osText.getText().length() > 0) {
				...
				str1.append("\nVisual Acuity - OS 20/ "+osText.getText()+" corrected");
			...
			if (odText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examEyeInputController.str);
				str1.append("\nVisual Acuity - OD 20/ "+odText.getText()+" corrected");
				examEyeInputController.str = str1.toString();
			...
			if (ouText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examEyeInputController.str);
				str1.append("\nVisual Acuity - OU 20/ "+ouText.getText()+" corrected");
				examEyeInputController.str = str1.toString();
