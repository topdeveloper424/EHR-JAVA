 ...
 *Module Name:
 *Parameter Definition: Type object of NeckCompressionInputController Class
 *Description: neckDistraction.fxml Controller class
...
public class NeckDistractionInputController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		doneBtn.setOnAction((event) -> {
			...
			if (negativeRadio.isSelected()) {
				...
				str1.append("Distraction negative.");
			...
			if (possitiveRadio.isSelected()) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneNeckInputController.str);
				str1.append("Distraction positive.");
				examMusculotoneNeckInputController.str = str1.toString();
