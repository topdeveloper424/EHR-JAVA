 ...
 *Module Name:
 *Parameter Definition: Type object of PenicillinesInputController Class
 *Description: penicillines.fxml GUI Controller class
...
public class PenicillinesInputController implements Initializable {
...
public void initialize(URL location, ResourceBundle resources) {
	AllergyCategory allergyCategories = new AllergyCategoryEntityController().searchByDescrip("Penicillins");
	...
	medicationSearchBtn.setOnAction((event) -> {
		...
		try {
			...
			allergyCategoryViewController.setPenicillinesInputController(this);
	...
	DoneButton.setOnAction((event) -> {
		...
		if(anaphylaxisCheck.isSelected()|| feverCheck.isSelected()||rashCheck.isSelected()
				...
				||itchingCheck.isSelected()|| dizzinessCheck.isSelected()){
