 ...
 *Module Name:
 *Parameter Definition: Type object of BackRibRomLumboInputController Class
...
public class BackRibRomLumboInputController implements Initializable{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		doneBtn.setOnAction((event) -> {
			...
			if (extensionText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneBackController.str);
				str1.append("\nL/S-Spine: Extension " +extensionText.getText()+" degrees (NL- 30 degrees)");
				examMusculotoneBackController.str = str1.toString();
			...
			if (rightRatationText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneBackController.str);
				str1.append("\nL/S-Spine: Right Rotation  " +rightRatationText.getText()+ " degrees (NL- 30 degrees)");
				examMusculotoneBackController.str = str1.toString();
			...
			if (leftRatationText.getText().length() > 0) {
				...
				StringBuilder str1 = new StringBuilder(examMusculotoneBackController.str);
				str1.append("\nL/S Spine: Left Rotation  " +leftRatationText.getText()+ " degrees (NL- 30 degrees)");
				examMusculotoneBackController.str = str1.toString();
