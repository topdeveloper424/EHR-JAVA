...
public class BMIGraphInputController implements Initializable {
	private GraphVitalsInputController GraphVitalsInputController;
	  
	   
	   Integer bmi = 0;
		public void setGraphVitalsInputController(GraphVitalsInputController graphVitalsInputController,String bmi) {
	    ...
	    void onMouseClick(MouseEvent event) {
			...
			series.getData().add(new XYChart.Data<String, Number>("109", 109));
			
			series.getData().add(new XYChart.Data<String, Number>(bmi.toString(), bmi));
