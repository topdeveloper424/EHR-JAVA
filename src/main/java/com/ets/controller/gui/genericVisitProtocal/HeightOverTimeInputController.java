...
public class HeightOverTimeInputController implements Initializable{

	private GraphVitalsInputController GraphVitalsInputController;
	  
	   
	   Integer height = 0;;
		public void setGraphVitalsInputController(GraphVitalsInputController graphVitalsInputController,String height) {
	    ...
	    void onMouseClick(MouseEvent event) {
			...
			series.getData().add(new XYChart.Data<String, Number>(height.toString(), height));
