...
public class WeightOverTimeInputController implements Initializable{

	private GraphVitalsInputController GraphVitalsInputController;
	  
	   
	   Integer weight = 0;;
		public void setGraphVitalsInputController(GraphVitalsInputController graphVitalsInputController,String weight) {
	    ...
	    void onMouseClick(MouseEvent event) {
			...
			series.getData().add(new XYChart.Data<String, Number>("12.0", 12));
			
			series.getData().add(new XYChart.Data<String, Number>(weight.toString(), weight));
